...
class Config {
	...
	class Colors {
		...
		static let primaryTintColor = UIColor(hex: "#02AAFF")
		static let secondaryTintColor = UIColor(hex: "#1F398E")
		
		static let destructiveColor = UIColor(hex: "#EF5454")
		static let constructiveColor = UIColor(hex: "#86C547")
		static let neutralColor = UIColor(hex: "#ACACAF")
		
		
		static let primaryTextColor = UIColor(hex: "#202020")
		static let secondaryTextColor = UIColor(hex: "#666666")
		static let alternativeTextColor = UIColor(hex: "#F3F3F3")
		static let warningsTextColor = UIColor(hex: "#EF5454")
		static let paleTextColor = UIColor(hex: "#666666")
		
		static let cellSelectionColor = UIColor(hex: "#FFF8DA")
